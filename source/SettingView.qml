    ...
    ColumnLayout {
        ...
        RowLayout{
            ...
            ComboBox {
                ...
                Layout.minimumHeight: 30
                Layout.maximumHeight: 30
                model: ["2400","4800", "9600","19200","38400","43000","57600","76800","115200","128000","230400","256000","460800","921600","1000000","2000000","3000000"]
                delegate: ItemDelegate{
                    id:itmdlg1
                    height: 30
                    width: parent.width
        ...
        RowLayout{
            ...
            ComboBox {
                ...
                delegate: ItemDelegate{
                    ...
                    background: Rectangle{
                        anchors.fill: parent
                        color:itmdlg3.hovered?"#507BF6":"white";
        ...
        RowLayout{
            ...
            ComboBox {
                ...
                delegate: ItemDelegate{
                    ...
                    background: Rectangle{
                        anchors.fill: parent
                        color:itmdlg4.hovered?"#507BF6":"white";
